...
# Зависимости
required_files = {
    "cathack.png": "https://github.com/Teapot174/M5Client/raw/main/Files/Background/cathack.png",
    "bruce.png": "https://github.com/Teapot174/M5Client/raw/main/Files/Background/bruce.png",
    "nemo.png": "https://github.com/Teapot174/M5Client/raw/main/Files/Background/nemo.png",
    "launcher.png": "https://github.com/Teapot174/M5Client/raw/main/Files/Background/launcher.png",
    "marauder.png": "https://github.com/Teapot174/M5Client/raw/main/Files/Background/marauder.png",
    "factory.png": "https://github.com/Teapot174/M5Client/raw/main/Files/Background/factory.png",
    "esptool.exe": "https://github.com/Teapot174/M5Client/raw/refs/heads/main/Files/esptool.exe",
    "icon.png": "https://github.com/Teapot174/M5Client/raw/main/Files/icon.png"
}

# Бины
firmware_urls = {
    "Bruce": {
        "Card": "https://github.com/Teapot174/M5Client/raw/refs/heads/main/Files/Firmwares/Bruce/Card.bin",
        "Plus1": "https://github.com/Teapot174/M5Client/raw/refs/heads/main/Files/Firmwares/Bruce/Plus1.bin",
        "Plus2": "https://github.com/Teapot174/M5Client/raw/refs/heads/main/Files/Firmwares/Bruce/Plus2.bin",
        "Embed": "https://github.com/Teapot174/M5Client/raw/refs/heads/main/Files/Firmwares/Bruce/Embed.bin"
    },
    "CatHack": {
        "Plus2": "https://github.com/Teapot174/M5Client/raw/refs/heads/main/Files/Firmwares/Cathack/Plus2.bin"
    },
    "Factory": {
        "Card": "https://github.com/Teapot174/M5Client/raw/refs/heads/main/Files/Firmwares/Factory/Card.bin",
        "Plus1": "https://github.com/Teapot174/M5Client/raw/refs/heads/main/Files/Firmwares/Factory/Plus1.bin",
        "Plus2": "https://github.com/Teapot174/M5Client/raw/refs/heads/main/Files/Firmwares/Factory/Plus2.bin",
        "Embed": "https://github.com/Teapot174/M5Client/raw/refs/heads/main/Files/Firmwares/Factory/Embed.bin"
    },
    "Launcher": {
        "Card": "https://github.com/Teapot174/M5Client/raw/refs/heads/main/Files/Firmwares/Launcher/Card.bin",
        "Plus1.1": "https://github.com/Teapot174/M5Client/raw/refs/heads/main/Files/Firmwares/Launcher/Plus1.bin",
        "Plus2": "https://github.com/Teapot174/M5Client/raw/refs/heads/main/Files/Firmwares/Launcher/Plus2.bin",
        "Embed": "https://github.com/Teapot174/M5Client/raw/refs/heads/main/Files/Firmwares/Launcher/Embed.bin"
    },
    "Marauder": {
        "Card": "https://github.com/Teapot174/M5Client/raw/refs/heads/main/Files/Firmwares/Marauder/Card.bin",
        "Plus1": "https://github.com/Teapot174/M5Client/raw/refs/heads/main/Files/Firmwares/Marauder/Plus1.bin",
        "Plus2": "https://github.com/Teapot174/M5Client/raw/refs/heads/main/Files/Firmwares/Marauder/Plus2.bin"
    },
    "Nemo": {
        "Card": "https://github.com/Teapot174/M5Client/raw/refs/heads/main/Files/Firmwares/Nemo/Card.bin",
        "Plus1": "https://github.com/Teapot174/M5Client/raw/refs/heads/main/Files/Firmwares/Nemo/Plus1.bin",
        "Plus2": "https://github.com/Teapot174/M5Client/raw/refs/heads/main/Files/Firmwares/Nemo/Plus2.bin"
    }
}
...
launcher_image = tk.PhotoImage(file=os.path.join(data_directory, "launcher.png"))
...
icon_image = tk.PhotoImage(file=os.path.join(data_directory, "icon.png"))
root.iconphoto(True, icon_image)  # Устанавливаем иконку окна
...
def switch_firmware():
    ...
    if current_firmware.get() == "CatHack":
        ...
        current_firmware.set("Launcher")
        switch_firmware_button.config(text="Launcher")
        img.config(image=launcher_image)
    elif current_firmware.get() == "Launcher":
...
def update_device_options():
    ...
    if current_firmware_value == "Factory":
        ...
        device_menu['menu'].add_command(label='Embed', command=lambda: device_var.set('Embed'))
    elif current_firmware_value == "CatHack":
        device_menu['menu'].add_command(label='Plus2', command=lambda: device_var.set('Plus2'))
    elif current_firmware_value == "Launcher":
        device_menu['menu'].add_command(label='Plus2', command=lambda: device_var.set('Plus2'))
        device_menu['menu'].add_command(label='Plus1', command=lambda: device_var.set('Plus1'))
        device_menu['menu'].add_command(label='Card', command=lambda: device_var.set('Card'))
        device_menu['menu'].add_command(label='Embed', command=lambda: device_var.set('Embed'))
        ...
        device_menu['menu'].add_command(label='Plus1', command=lambda: device_var.set('Plus1'))
        device_menu['menu'].add_command(label='Card', command=lambda: device_var.set('Card'))
    elif current_firmware_value == "Bruce":
        device_menu['menu'].add_command(label='Plus2', command=lambda: device_var.set('Plus2'))
        device_menu['menu'].add_command(label='Plus1', command=lambda: device_var.set('Plus1'))
        device_menu['menu'].add_command(label='Card', command=lambda: device_var.set('Card'))
        device_menu['menu'].add_command(label='Embed', command=lambda: device_var.set('Embed'))
...
def open_drivers_page():
    webbrowser.open("https://github.com/Teapot174/M5Client/tree/main/Secondary/Drivers")
